...
def step_count( into_file_name ):
	...
	for index01 in range(1, len(acc_input)-1, 1): 
		...
		# Follow up step count			
			...
			if( ( int(element_01[0]) - int(pre_stroke_count_x[0]) >= time_interval_threshold) & (int(element_01[0]) - int(pre_stroke_count_x[0]) < 5000) ):
	...
	print "step count =",len(stroke_count_x_list) * 2 #, step_counter  #, stroke_count_x_list
	...
	ax = fig.add_subplot(411, autoscale_on=False, xlim=(0,190000), ylim=(-7,7))  
	ax.set_title('Acc_X')
	...
	fig = figure(1,figsize=(120,15))
	ax = fig.add_subplot(412, autoscale_on=False, xlim=(0,190000), ylim=(-4,5))
	ax.set_title('Acc_Y')
	...
	fig = figure(1,figsize=(120,15))
	ax = fig.add_subplot(413, autoscale_on=False, xlim=(0,190000), ylim=(-5,6))
	ax.set_title('Acc_Z')
...
# step_count("20140718_170104_Foot_Walkfast_Dang_Ren_K89_425_0")